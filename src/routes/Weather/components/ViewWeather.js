...
export class ViewWeather extends React.Component {
  ...
  render () {
    const statusWeather = this.props.infoCity.weather
    let name,
      img,
      clouds,
      humidity,
    ...
    if (statusWeather) {
      img = `http://openweathermap.org/img/w/${this.props.infoCity.weather[0].icon}.png`
        ...
        <div style={{float: 'left', width: '130px'}}>
          <div style={{display: 'block', clear: 'left'}}>
            ...
            <div style={{float: 'left'}}>
              <div style={{display: 'block', clear: 'left', fontSize: 'medium', fontWeight: 'bold', padding: '0pt 3pt'}}
          ...
          <div style={{display: 'block', clear: 'left', color: 'gray', fontSize: 'x-small'}}>Humidity: {humidity}%</div>
